...
const SvgBlendingMode = (props: SvgProps) => <Svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 15 15" {...props}><Path fill="currentColor" d="M7.5 1.5c3 2.75 4.5 5 4.5 7.5l-.006.231A4.5 4.5 0 0 1 3 9c0-2.5 1.5-4.75 4.5-7.5m0 1.376C5.028 5.274 4 7.112 4 9q.001.425.098.82c1.864.428 4.534-2.39 6.854-1.516C10.725 6.65 9.668 4.978 7.5 2.876" /></Svg>;
